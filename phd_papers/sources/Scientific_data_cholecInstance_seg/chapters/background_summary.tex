...
\revdel{To overcome these challenges, we introduce the CholecInstanceSeg open-access dataset, in which we meticulously annotate 41,933 frames extracted from 85 laparoscopic cholecystectomy procedures from the existing Cholec80 \mbox{~\cite{endonet_cis}}
 and CholecT50 \mbox{~\cite{NWOYE2022102433_rendevous_cis}} datasets.}

To overcome these challenges, we introduce the CholecInstanceSeg open-access dataset, in which we meticulously annotate 41,933 frames from the existing Cholec80~\cite{endonet_cis} and CholecT50~\cite{NWOYE2022102433_rendevous_cis} datasets \robustrevref{1}{2}\revnew{with instance segmentation labels and class labels for 7 instrument classes: Grasper, Bipolar, Hook, Clipper, Scissors, Irrigator, and Snare. 
...
\begin{table}[ht]
  ...
  \begin{tabular}{|l|l|l|l|l|l|l|} 
    ...
    \hline
    Endovis2017 \cite{endovis2017_cis} & Porcine & In-vivo  & 10 & 2.4k  & 10 classes  & No  \\
    \hline
    Endovis2018 \cite{endovis2018_cis} & Porcine & In-vivo & 16 & 2.4k  &  10 classes & No  \\
    \hline
    CholecSeg8k \cite{cholecseg8k_cis} & Human & In-vivo & 17 &  8k   & 12 classes&  No \\
    \hline
    AutoLaparo (Multitask) \cite{autolaparo_cis} & Human & In-vivo & 21 & 1.8k  & 7 classes  & No   \\
    \hline
    ROBUSTMIS2019 \cite{robustmis2019_cis} & Human & In-vivo & 30 &  10k   & 2 classes & Yes\greencheck \\
    \hline
    SAR-RARP50 (Multitask) \cite{psychogyios2023sar_cis} & Human & In-vivo & 50  & 10k  & 10 classes  & No \\ 
    \hline
...
CholecInstanceSeg is ideally suited for training models on instance and semantic segmentation for laparoscopic surgeries. Additionally, it can be effectively integrated with other datasets that utilize surgical procedure videos from Cholec80 and CholecT50. These datasets, derived from Cholec80 and CholecT50 share frames with CholecInstanceSeg but are annotated for different tasks, such as phase recognition (Cholec80 \cite{endonet_cis}) instrument action and target detection (CholecT50 \cite{NWOYE2022102433_rendevous_cis}), and Critical View of Safety (CVS) assessment (Cholec80-CVS \cite{rios2023cholec80}).
