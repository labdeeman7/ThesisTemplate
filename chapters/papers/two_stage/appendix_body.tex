...
During training, the complete three-stage dialogue is supplied with the reference assistant response at each stage. During inference, the generated verb and target responses remain in the conversation before the final request. Only the final triplet response is evaluated.
