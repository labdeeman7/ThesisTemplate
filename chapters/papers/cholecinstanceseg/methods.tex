...
These datasets are publicly available subsets of the in-house Cholec120 dataset \cite{twinanda2018rsdnet} from the CAMMA research group \robustrevref{1}{7}\revnew{which was recorded at the University Hospital of Strasbourg \cite{EndoNet,NWOYE2022102433_rendevous}} 
...
CholecInstanceSeg includes frames from publicly available datasets that already have the necessary consents and ethical considerations. Additionally, the licenses for the source datasets permit the enhancement of the data with further annotations (\href{https://github.com/CAMMA-public/TF-Cholec80}{Cholec80 license}, \href{https://github.com/CAMMA-public/cholect50}{CholecT50 license}, \href{https://www.kaggle.com/datasets/newslab/cholecseg8k}{CholecSeg8k license}).
