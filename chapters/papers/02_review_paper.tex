...
\begin{longtable}{|p{1.29cm}|p{3.00cm}|p{0.70cm}|p{2.00cm}|p{1.80cm}|p{2.30cm}|p{1.60cm}|}
...
\endfoot
  \hline
\endlastfoot
  \multicolumn{1}{|l|}{\parbox{1.20cm}{\raggedright\hspace{0pt}
  \href{https://autolaparo.github.io/}{AutoLaparo}
  }} & \multicolumn{1}{l|}{\parbox{2.90cm}{\raggedright\hspace{0pt}A dataset for image-guided surgical automation in laparoscopic hysterectomy comprising three sub-datasets: surgical workflow recognition, laparoscope motion prediction, instrument and anatomy segmentation. } }
  &
  \multicolumn{1}{l|}{\parbox{0.60cm}{\raggedright\hspace{0pt}21} }
  & Phase recognition task
  & 1388 minutes of surgical videos  
  & 1388 minutes of phase labels 
  & \multicolumn{1}{l|}{\parbox{1.50cm}{\raggedright\hspace{0pt}\citep{autolaparo} }}  \\  \bluecline{4-6}
  ...
  \hline
  \multicolumn{1}{|l|}{\parbox{1.20cm}{\raggedright\hspace{0pt}   \href{https://www.synapse.org/\#!Synapse:syn25101790/wiki/}{Hei\-SURF}
  }} 
  & \multicolumn{1}{l|}{\parbox{2.90cm}{\raggedright\hspace{0pt} A laparoscopic cholecystectomy designed for surgical activity recognition, full scene segmentation, and skill assessment. It is a parent dataset to the HeiChole dataset} }
  & \multicolumn{1}{l|}{\parbox{0.60cm}{\raggedright\hspace{0pt}33} }
  & Phase recognition
  & 23.3 hours of surgical videos
  & 23.3 hours of phase labels
  & \multicolumn{1}{l|}{\parbox{1.50cm}{\raggedright\hspace{0pt}\citep{heisurf}} }  \\  \bluecline{4-6}
  & &  
  ...
  & \multicolumn{1}{l|}{\parbox{2.90cm}{\raggedright\hspace{0pt} A dataset of robot-assisted radical prostatectomy designed for research into the complementary nature of surgical activity recognition tasks.} }
  & \multicolumn{1}{l|}{\parbox{0.60cm}{\raggedright\hspace{0pt} 8 } }
  & Phase recognition
  & 20.45 hours of surgical videos
  & 20.45 hours of phase labels
  & \multicolumn{1}{l|}{\parbox{1.50cm}{\raggedright\hspace{0pt}\citep{holistic_scene_understanding}} } \\  \bluecline{4-6}
  & &  
  & Step recognition
  & 20.45 hours of surgical videos
  ...
  \hline
  \multicolumn{1}{|l|}{\parbox{1.20cm}{\raggedright\hspace{0pt}  \href{https://www.synapse.org/\#!Synapse:syn21903917/wiki/601992}{HeiCo}
  }} & \multicolumn{1}{l|}{\parbox{2.90cm}{\raggedright\hspace{0pt} A dataset of three different colorectal procedures (proctocolectomy, rectal resection, and sigmoid resection procedures) with emphasis on dataset generalization and diversity.} }
  & \multicolumn{1}{l|}{\parbox{0.60cm}{\raggedright\hspace{0pt}30} }
  & Phase recognition
  & 9.45 hours of surgical videos
  & 9.45 hours of phase labels
  & \multicolumn{1}{l|}{\parbox{1.50cm}{\raggedright\hspace{0pt}\citep{heico}} }\\  \bluecline{4-6}
  & &  
  ...
  \hline
  \multicolumn{1}{|l|}{\parbox{1.20cm}{\raggedright\hspace{0pt}\href{https://www.synapse.org/\#!Synapse:syn21776936/wiki/601700}{MISAW} 
  }} 
  & \multicolumn{1}{l|}{\parbox{2.90cm}{\raggedright\hspace{0pt} A micro-surgical anastomosis dataset with a focus on evaluating the impact of learning multiple surgical activity recognition tasks together.} }
  & \multicolumn{1}{l|}{\parbox{0.60cm}{\raggedright\hspace{0pt} 27 } }
  & Phase recognition
  & 1.5 hours of surgical videos
  & 1.5 hours of phase labels
  & \multicolumn{1}{l|}{\parbox{1.50cm}{\raggedright\hspace{0pt}\citep{huaulme2021micro}} }\\  \bluecline{4-6}
  & &  
  & Step recognition
  & 1.5 hours of surgical videos
  ...
  \hline
  \multicolumn{1}{|l|}{\parbox{1.20cm}{\raggedright\hspace{0pt}\href{https://www.synapse.org/\#!Synapse:syn25147789/wiki/}{PETRAW} 
  }} 
  & \multicolumn{1}{l|}{\parbox{2.90cm}{\raggedright\hspace{0pt}A dataset containing the peg transfer task in laparoscopic surgery training. It is designed for multiple surgical activity recognition tasks. This dataset is collected from a virtual reality simulator} }
  & \multicolumn{1}{l|}{\parbox{0.60cm}{\raggedright\hspace{0pt} 150 } }
  & Phase recognition
  & 5.86 hours of surgical videos
  & 5.86 hours of phase labels
  & \multicolumn{1}{l|}{\parbox{1.50cm}{\raggedright\hspace{0pt}\citep{huaulme2022peg}} } \\  \bluecline{4-6}
  & &  
  & Step recognition
  & 5.86 hours of surgical videos
  ...
  \hline
  \multicolumn{1}{|l|}{\parbox{1.20cm}{\raggedright\hspace{0pt}  \href{https://github.com/CAMMA-public/MultiBypass140}{Multi-}\\\href{https://github.com/CAMMA-public/MultiBypass140}{Bypass}\\\href{https://github.com/CAMMA-public/MultiBypass140}{140}
  }} 
  & \multicolumn{1}{l|}{\parbox{2.90cm}{\raggedright\hspace{0pt}A phase and step recognition dataset, particularly focusing on datasets collected from different hospitals (multi-centric) and the importance of multi-centric datasets for generalization. } }
  & \multicolumn{1}{l|}{\parbox{0.60cm}{\raggedright\hspace{0pt}140} }
  & Phase recognition
  & 214hrs of surgical videos
  & 214hrs of phase labels
  & \multicolumn{1}{l|}{\parbox{1.50cm}{\raggedright\hspace{0pt}\citep{Lavanchy2024}} }  \\  \bluecline{4-6}
  & &  
  & Step recognition
  & 214hrs of videos
  ...
  & \multicolumn{1}{l|}{\parbox{2.90cm}{\raggedright\hspace{0pt}A dataset of suturing segments of robotic assisted radical prostatectomy. The dataset focuses on tool segmentation and surgical action recognition.} }
  & \multicolumn{1}{l|}{\parbox{0.60cm}{\raggedright\hspace{0pt}50} }
  & Phase recognition
  & 3 hours of surgical videos
  & 3 hours of action labels
  & \parbox{1.50cm}{\raggedright\hspace{0pt}\citep{psychogyios2023sar}}\\  \bluecline{4-6}
  & &  
  ...
  & \multicolumn{1}{l|}{\parbox{2.90cm}{\raggedright\hspace{0pt}A dataset containing both real and virtual human prostatectomy procedures for research into surgical activity recognition and instrument detection with a focus on cross-domain learning} }
  & \multicolumn{1}{l|}{\parbox{0.60cm}{\raggedright\hspace{0pt}9} }
  & Instrument detection
  & 59k frames
  & 59k frames with bounding boxes 
  & \multicolumn{1}{l|}{\parbox{1.50cm}{\raggedright\hspace{0pt}\citep{saras_mesad}} }  \\  \bluecline{4-6}
  & &  
  & Action recognition
  & 59k frames
  ...
  \hline
  \multicolumn{1}{|l|}{\parbox{1.20cm}{\raggedright\hspace{0pt}
  \href{https://cholectriplet2021.grand-challenge.org/}{Cholec\allowbreak T50}
  }} 
  & \multicolumn{1}{l|}{\parbox{2.90cm}{\raggedright\hspace{0pt}The CholecT50 is designed for fine-grained action recognition and tool-tissue interaction in laparoscopic cholecystectomy surgeries. CholecT50 is the latest in the Cholec series of datasets. } }
  & \multicolumn{1}{l|}{\parbox{0.60cm}{\raggedright\hspace{0pt} 50} }
  & Tool presence recognition  
  & 100.9k frames  
  & 100.9k frames with tool presence labels 
  & \multicolumn{1}{l|}{\parbox{1.50cm}{\raggedright\hspace{0pt}\citep{NWOYE2022102433_rendevous}} } \\  \bluecline{4-6}
  & &  
  & Action recognition
  & 100.9k frames
  ...
  \multicolumn{1}{l|}{\parbox{2.90cm}{\raggedright\hspace{0pt}A non-robotic laparoscopic hysterectomy dataset designed for 3D graphics applications like 3D measurement and Augmented Reality~(AR). } }
  & \multicolumn{1}{l|}{\parbox{0.60cm}{\raggedright\hspace{0pt}29} }
  & Tool presence prediction
  & 1500 frames
  & 1500 frames with tool presence labels
  & \multicolumn{1}{l|}{\parbox{1.50cm}{\raggedright\hspace{0pt}\citep{art_net}} }  \\  \bluecline{4-6}
  & &  
 ...
 \\ 
  ...
  \hline
  \multicolumn{1}{|l|}{\parbox{1.20cm}{\raggedright\hspace{0pt}  \href{https://github.com/lalithjets/SurgicalGPT}{EndoVis-18-VQA}
  }} 
  & \multicolumn{1}{l|}{\parbox{2.90cm}{\raggedright\hspace{0pt}A dataset designed for advancing research in visual question answering using the Endovis2018 dataset. It contains classification-based questions about tissues, actions and tool locations. } }
  & \multicolumn{1}{l|}{\parbox{0.60cm}{\raggedright\hspace{0pt}14} }
  & VQA
  & 11.7k questions
  & 2k frames  
  & \multicolumn{1}{l|}{\parbox{1.50cm}{\raggedright\hspace{0pt}\citep{seenivasan2022surgical}} }  \\
  & &  
  & 
  & 
  & 
  ...
  \\
  \hline 
  \multicolumn{1}{|l|}{\parbox{1.20cm}{\raggedright\hspace{0pt}  \href{https://github.com/lalithjets/SurgicalGPT}{Cholec}\\\href{https://github.com/lalithjets/SurgicalGPT}{80-VQA}
  }} 
  & \multicolumn{1}{l|}{\parbox{2.90cm}{\raggedright\hspace{0pt}A Surgical VQA dataset based on the Cholec80 dataset. It contains classification-based questions about surgical phases and instrument presence. } }
  & \multicolumn{1}{l|}{\parbox{0.60cm}{\raggedright\hspace{0pt}40} }
  & VQA
  & 43k questions
  & 21.6k frames  
  & \multicolumn{1}{l|}{\parbox{1.50cm}{\raggedright\hspace{0pt}\citep{seenivasan2022surgical}} }  \\
  ...
  \\
  \hline  
  \multicolumn{1}{|l|}{\parbox{1.20cm}{\raggedright\hspace{0pt}  \href{https://github.com/lalithjets/SurgicalGPT}{PSI-AVA-VQA}
  }} 
  & \multicolumn{1}{l|}{\parbox{2.90cm}{\raggedright\hspace{0pt}A Surgical VQA dataset based on the PSI-AVA dataset . It contains classification-based questions about the surgical phase, step, and location of surgical tools. } }
  & \multicolumn{1}{l|}{\parbox{0.60cm}{\raggedright\hspace{0pt}8} }
  & VQA
  & 10.3k questions
  & 2.2k frames
  & \multicolumn{1}{l|}{\parbox{1.50cm}{\raggedright\hspace{0pt}\citep{seenivasan2023surgicalgpt}} }  \\
  & &  
  & 
  & 
  & 
  ...
  \\
  \hline 
  \multicolumn{1}{|l|}{\parbox{1.20cm}{\raggedright\hspace{0pt}  \href{https://github.com/CAMMA-public/SSG-VQA}{SSG-VQA}
  }} 
  & \multicolumn{1}{l|}{\parbox{2.90cm}{\raggedright\hspace{0pt}A Surgical VQA dataset comprising images from the CholecT45 dataset. It contains complex questions about tool location and presence, tissue location and presence, instrument action, instrument targets, object colours, and their relationships } }
  & \multicolumn{1}{l|}{\parbox{0.60cm}{\raggedright\hspace{0pt}45} }
  & VQA
  & 960k questions
  & 25k frames 
  & \multicolumn{1}{l|}{\parbox{1.50cm}{\raggedright\hspace{0pt}\citep{yuan2024advancing}} }  \\
  & &  
  & 
  & 
  & 
  ...
  \\
  \hline
  \multicolumn{1}{|l|}{\parbox{1.20cm}{\raggedright\hspace{0pt}\href{https://cirl.lcsr.jhu.edu/research/hmm/datasets/jigsaws_release/}{JIGSAWS}}} 
  & \multicolumn{1}{l|}{\parbox{2.90cm}{\raggedright\hspace{0pt}An automatic gesture recognition and surgical skill assessment dataset containing videos of surgeons performing suturing, knot-tying and needle-passing on a bench-top model with a da Vinci. } }
  & \multicolumn{1}{l|}{\parbox{0.60cm}{\raggedright\hspace{0pt} 104 } }
  & Surgical gesture classification
  & 208 minutes of surgical videos
  & 208 minutes of surgical gesture labels  
  & \multicolumn{1}{l|}{\parbox{1.50cm}{\raggedright\hspace{0pt}\citep{jigsaws}} }\\  \bluecline{4-6}
  & &  
  & Surgical skill-score prediction
  & 104 video clips 
  ...
  \hline
  \multicolumn{1}{|l|}{\parbox{1.20cm}{\raggedright\hspace{0pt}  \href{https://github.com/CAMMA-public/Endoscapes}{Endoscapes}
  }} 
  & \multicolumn{1}{l|}{\parbox{2.90cm}{\raggedright\hspace{0pt}Endoscapes dataset was designed for advancing research on the Critical View of Safety (CVS), segmentation and object in Laparoscopic Cholecystectomy surgeries.} }
  & \multicolumn{1}{l|}{\parbox{0.60cm}{\raggedright\hspace{0pt}201} }
  & CVS prediction
  & 58.8k frames
  & 58.8k frames with CVS labels 
  & \multicolumn{1}{l|}{\parbox{1.50cm}{\raggedright\hspace{0pt}\citep{murali2023endoscapes}} }  \\  \bluecline{4-6}
  & &  
...
\label{sec:review-workflow-discussion}
...
A complementary direction is to move beyond recognising that an interaction occurs and determine which physical instrument instance performs it. This requires spatially grounding each predicted \ivttriplet in an individual instrument rather than associating interactions only with the frame or instrument class. The subsequent technical chapters pursue this progression: Chapter~\ref{chap:cholecinstanceseg} establishes instrument-instance supervision, Chapter~\ref{chap:triplet-grounding} connects those instances to verb and target labels, and Chapter~\ref{chap:two-stage-interaction} investigates instrument instance segmentation followed by multimodal interaction prediction.
