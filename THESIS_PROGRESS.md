...
- Establish project tracking and correct the thesis source map.
- Preserve the authoritative Two Stage Surgical Triplet Segmentation manuscript in version control.
